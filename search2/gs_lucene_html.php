 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class gs_lucene_html extends Zend_Search_Lucene_Document
{
    /**
     ...
     * Object constructor
     *
     * @param gs_document $doc         HTML string (may be HTML fragment, )
     * @param boolean $storeContent
     * @param string  $defaultEncoding   HTML encoding, is used if it's not specified using Content-type HTTP-EQUIV meta tag.
     */
    public function __construct(gs_document $doc, $storeContent=false, $defaultEncoding = '')
    {
        $this->doc = $doc;
