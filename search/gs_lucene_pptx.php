 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class gs_lucene_pptx extends Zend_Search_Lucene_Document_OpenXml
{
    /**
     ...
     * Object constructor
     *
     * @param gs_document $doc
     * @param boolean $storeContent
     * @throws Zend_Search_Lucene_Exception
     */
    public function __construct(gs_document $doc, $storeContent=false)
    {
        ...
        foreach ($relations->Relationship as $rel) {
            if ($rel["Type"] == Zend_Search_Lucene_Document_OpenXml::SCHEMA_OFFICEDOCUMENT) {
                ...
                foreach ($slideRelations->Relationship as $slideRel) {
                    if ($slideRel["Type"] == gs_lucene_pptx::SCHEMA_SLIDERELATION) {
                        // Found slide!
                        ...
                        foreach ($slideNotesRelations->Relationship as $slideNoteRel) {
                            if ($slideNoteRel["Type"] == gs_lucene_pptx::SCHEMA_SLIDENOTESRELATION) {
                                // Found slide notes!
        ...
        foreach ($slides as $slideKey => $slide) {
            // Register namespaces
            $slide->registerXPathNamespace("p", gs_lucene_pptx::SCHEMA_PRESENTATIONML);
            $slide->registerXPathNamespace("a", gs_lucene_pptx::SCHEMA_DRAWINGML);
            ...
            if (isset($slideNotes[$slideKey])) {
                ...
                // Register namespaces
                $slideNote->registerXPathNamespace("p", gs_lucene_pptx::SCHEMA_PRESENTATIONML);
                $slideNote->registerXPathNamespace("a", gs_lucene_pptx::SCHEMA_DRAWINGML);
